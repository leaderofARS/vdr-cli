export type WebhookEventType = 'anchor.created' | 'anchor.confirmed' | 'anchor.failed' | 'verification.performed' | 'anomaly.detected' | 'quota.warning' | 'quota.exceeded' | 'certificate.generated';
